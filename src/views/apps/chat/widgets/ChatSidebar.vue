...
<template>
  <n-card class="chat-sidebar" :class="{ 'mobile-open': chatStore.mobileMenuOpen }" :bordered="false">
    <div 
      class="sidebar-overlay" 
      :class="{ 'show': chatStore.mobileMenuOpen }"
      @click="chatStore.mobileMenuOpen = false"
    ></div>

    <div class="sidebar-content" :class="{ 'show': chatStore.mobileMenuOpen }">

      <!-- Mobile Profile Header (Inside Drawer) -->
      <div class="sidebar-header desktop-profile-header">
      ...
      <div class="sidebar-section">
        ...
        <n-space vertical size="small">
          <div
            ...
            @click="() => { chatStore.activeChatId = chat.id; chatStore.mobileMenuOpen = false; }"
          >
            <n-avatar round :size="32" :style="{ backgroundColor: chat.color }" class="contact-avatar">
              {{ chat.initials }}
            </n-avatar>
      ...
      <div class="sidebar-section">
        ...
        <n-space vertical size="small">
          <div
            ...
            :key="contact.id"
            class="contact-item"
            @click="() => { chatStore.startNewChat(contact); chatStore.mobileMenuOpen = false; }"
          >
            <n-avatar
              round
              :size="32"
