              ...
              <div>
                ...
                <n-space vertical :size="12">
                  <div>
                    ...
                    <n-countdown :duration="2 * 60 * 60 * 1000" :active="active" :render="renderTime" />
                  </div>
                  <div>
                    <span style="color: var(--text-secondary); margin-right: 12px;">With Labels:</span>
                    <n-countdown :duration="60 * 60 * 1000" :active="active" :render="renderWithLabels" />
                  </div>
                  <div>
                    <span style="color: var(--text-secondary); margin-right: 12px;">Compact Format:</span>
                    <n-countdown :duration="30 * 60 * 1000" :active="active" :render="renderCompact" />
                  </div>
                </n-space>
              </div>
              ...
              <div>
                ...
                <n-space vertical :size="12">
                  <div>
                    ...
                    <n-countdown :duration="60 * 60 * 1000" :active="active" :render="renderCardStyle" />
                  </div>
                  <div>
                    <span style="color: var(--text-secondary); margin-right: 12px;">Progress Style:</span>
                    <n-countdown :duration="60 * 60 * 1000" :active="active" :render="renderProgressStyle" />
                  </div>
                </n-space>
              </div>
            </n-space>
              ...
              <div>
                ...
                <n-space vertical :size="12">
                  <div>
                    ...
                    <n-countdown :duration="5 * 1000" :active="eventActive" @finish="handleFinish" />
                  </div>
              ...
              <div>
                ...
                <n-card style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                  <div style="text-align: center; padding: 20px;">
                    ...
                    <n-countdown :duration="2 * 60 * 60 * 1000" :active="active" :render="renderFlashSale" />
                ...
                <n-card>
                  ...
                  <n-space vertical :size="16">
                    <div>
                      ...
                      <n-countdown :duration="90 * 60 * 1000" :active="active" :render="renderExamTimer" />
                    </div>
                    <n-space>
                ...
                <n-card>
                  ...
                  <n-space vertical :size="16">
                    ...
                    <div>
                      ...
                      <n-countdown :duration="30 * 60 * 1000" :active="active" :render="renderAuctionTimer" />
                    </div>
                    <n-space>
