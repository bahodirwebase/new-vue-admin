...
.error-page {
  ...
  min-height: 100vh;
  background: linear-gradient(135deg, var(--primary-color) 0%, var(--color-error) 100%);
  color: white;
}
...
[data-theme="dark"] .error-page {
  background: linear-gradient(135deg, var(--primary-color-800) 0%, var(--color-error) 100%);
}
